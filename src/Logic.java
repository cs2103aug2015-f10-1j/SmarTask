...
public class Logic {
    ...
    private static ArrayList <String> inputList ; // arraylist to store task to txt file
    private static ArrayList <String> taskList; // arraylist use to hold the data from txt file
