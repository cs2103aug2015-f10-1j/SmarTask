	...
	public static void main(String[] args) throws Exception {
		...
		try {
			Command repeat = CommandParser
					.parse("repeat daily -start 15 Nov 5 to 6 pm -every 2 day -until 15 Dec 2016");
		...
		try {
			Command repeat = CommandParser
					.parse("repeat weekly -start 25 Dec 9 to 11am -every 2 week -on sun, sat, wed -until 25 Dec 15");
			System.out.println(repeat.getCommandType() + " " + repeat.getTaskDescription() + " " + repeat.getDateAdded()
					+ " " + repeat.getRepeatStartTime() + " " + repeat.getRepeatEndTime() + " " + repeat.getRepeatType()
		...
		try {
			Command repeat = CommandParser.parse(
					"update r10111512 team project meeting -start 19 Nov 9 to 11am -every 5 week -on sun, mon, sat -until 25 Dec 15");
